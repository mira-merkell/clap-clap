...
pub const CLAP_PLUGIN_FEATURE_INSTRUMENT: &::std::ffi::CStr = c"instrument";
pub const CLAP_PLUGIN_FEATURE_AUDIO_EFFECT: &::std::ffi::CStr = c"audio-effect";
pub const CLAP_PLUGIN_FEATURE_NOTE_EFFECT: &::std::ffi::CStr = c"note-effect";
pub const CLAP_PLUGIN_FEATURE_NOTE_DETECTOR: &::std::ffi::CStr = c"note-detector";
pub const CLAP_PLUGIN_FEATURE_ANALYZER: &::std::ffi::CStr = c"analyzer";
pub const CLAP_PLUGIN_FEATURE_SYNTHESIZER: &::std::ffi::CStr = c"synthesizer";
pub const CLAP_PLUGIN_FEATURE_SAMPLER: &::std::ffi::CStr = c"sampler";
pub const CLAP_PLUGIN_FEATURE_DRUM: &::std::ffi::CStr = c"drum";
pub const CLAP_PLUGIN_FEATURE_DRUM_MACHINE: &::std::ffi::CStr = c"drum-machine";
pub const CLAP_PLUGIN_FEATURE_FILTER: &::std::ffi::CStr = c"filter";
pub const CLAP_PLUGIN_FEATURE_PHASER: &::std::ffi::CStr = c"phaser";
pub const CLAP_PLUGIN_FEATURE_EQUALIZER: &::std::ffi::CStr = c"equalizer";
pub const CLAP_PLUGIN_FEATURE_DEESSER: &::std::ffi::CStr = c"de-esser";
pub const CLAP_PLUGIN_FEATURE_PHASE_VOCODER: &::std::ffi::CStr = c"phase-vocoder";
pub const CLAP_PLUGIN_FEATURE_GRANULAR: &::std::ffi::CStr = c"granular";
pub const CLAP_PLUGIN_FEATURE_FREQUENCY_SHIFTER: &::std::ffi::CStr = c"frequency-shifter";
pub const CLAP_PLUGIN_FEATURE_PITCH_SHIFTER: &::std::ffi::CStr = c"pitch-shifter";
pub const CLAP_PLUGIN_FEATURE_DISTORTION: &::std::ffi::CStr = c"distortion";
pub const CLAP_PLUGIN_FEATURE_TRANSIENT_SHAPER: &::std::ffi::CStr = c"transient-shaper";
pub const CLAP_PLUGIN_FEATURE_COMPRESSOR: &::std::ffi::CStr = c"compressor";
pub const CLAP_PLUGIN_FEATURE_EXPANDER: &::std::ffi::CStr = c"expander";
pub const CLAP_PLUGIN_FEATURE_GATE: &::std::ffi::CStr = c"gate";
pub const CLAP_PLUGIN_FEATURE_LIMITER: &::std::ffi::CStr = c"limiter";
pub const CLAP_PLUGIN_FEATURE_FLANGER: &::std::ffi::CStr = c"flanger";
pub const CLAP_PLUGIN_FEATURE_CHORUS: &::std::ffi::CStr = c"chorus";
pub const CLAP_PLUGIN_FEATURE_DELAY: &::std::ffi::CStr = c"delay";
pub const CLAP_PLUGIN_FEATURE_REVERB: &::std::ffi::CStr = c"reverb";
pub const CLAP_PLUGIN_FEATURE_TREMOLO: &::std::ffi::CStr = c"tremolo";
pub const CLAP_PLUGIN_FEATURE_GLITCH: &::std::ffi::CStr = c"glitch";
pub const CLAP_PLUGIN_FEATURE_UTILITY: &::std::ffi::CStr = c"utility";
pub const CLAP_PLUGIN_FEATURE_PITCH_CORRECTION: &::std::ffi::CStr = c"pitch-correction";
pub const CLAP_PLUGIN_FEATURE_RESTORATION: &::std::ffi::CStr = c"restoration";
pub const CLAP_PLUGIN_FEATURE_MULTI_EFFECTS: &::std::ffi::CStr = c"multi-effects";
pub const CLAP_PLUGIN_FEATURE_MIXING: &::std::ffi::CStr = c"mixing";
pub const CLAP_PLUGIN_FEATURE_MASTERING: &::std::ffi::CStr = c"mastering";
pub const CLAP_PLUGIN_FEATURE_MONO: &::std::ffi::CStr = c"mono";
pub const CLAP_PLUGIN_FEATURE_STEREO: &::std::ffi::CStr = c"stereo";
pub const CLAP_PLUGIN_FEATURE_SURROUND: &::std::ffi::CStr = c"surround";
pub const CLAP_PLUGIN_FEATURE_AMBISONIC: &::std::ffi::CStr = c"ambisonic";
...
pub struct clap_plugin_entry {
    ...
    pub init:
        ::std::option::Option<unsafe extern "C" fn(plugin_path: *const std::ffi::c_char) -> bool>,
    pub deinit: ::std::option::Option<unsafe extern "C" fn()>,
    pub get_factory: ::std::option::Option<
        unsafe extern "C" fn(factory_id: *const std::ffi::c_char) -> *const std::ffi::c_void,
    >,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
pub struct clap_host {
    ...
    pub vendor: *const std::ffi::c_char,
...
pub type clap_event_flags = std::ffi::c_uint;
...
pub type clap_transport_flags = std::ffi::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct clap_plugin_descriptor {
    ...
    pub vendor: *const std::ffi::c_char,
    pub url: *const std::ffi::c_char,
    pub manual_url: *const std::ffi::c_char,
    pub support_url: *const std::ffi::c_char,
    pub version: *const std::ffi::c_char,
...
pub const CLAP_PLUGIN_FACTORY_ID: &::std::ffi::CStr = c"clap.plugin-factory";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_PRESET_DISCOVERY_FACTORY_ID: &::std::ffi::CStr = c"clap.preset-discovery-factory/2";
pub const CLAP_PRESET_DISCOVERY_FACTORY_ID_COMPAT: &::std::ffi::CStr =
...
pub type clap_preset_discovery_location_kind = std::ffi::c_uint;
...
pub type clap_preset_discovery_flags = std::ffi::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct clap_preset_discovery_metadata_receiver {
    pub receiver_data: *mut std::ffi::c_void,
    ...
    pub set_soundpack_id: ::std::option::Option<
        unsafe extern "C" fn(
            receiver: *const clap_preset_discovery_metadata_receiver,
            soundpack_id: *const std::ffi::c_char,
        ),
    >,
...
pub struct clap_preset_discovery_filetype {
    pub name: *const std::ffi::c_char,
    pub description: *const std::ffi::c_char,
    pub file_extension: *const std::ffi::c_char,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
pub struct clap_preset_discovery_location {
    ...
    pub name: *const std::ffi::c_char,
    pub kind: u32,
    pub location: *const std::ffi::c_char,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
pub struct clap_preset_discovery_soundpack {
    ...
    pub name: *const std::ffi::c_char,
    pub description: *const std::ffi::c_char,
    pub homepage_url: *const std::ffi::c_char,
    pub vendor: *const std::ffi::c_char,
    pub image_path: *const std::ffi::c_char,
...
pub struct clap_preset_discovery_provider {
    ...
    pub provider_data: *mut std::ffi::c_void,
...
pub struct clap_preset_discovery_indexer {
    ...
    pub url: *const std::ffi::c_char,
    pub version: *const std::ffi::c_char,
    pub indexer_data: *mut std::ffi::c_void,
...
pub struct clap_preset_discovery_factory {
    ...
    pub create: ::std::option::Option<
        unsafe extern "C" fn(
            ...
            provider_id: *const std::ffi::c_char,
...
pub const CLAP_EXT_AMBISONIC: &::std::ffi::CStr = c"clap.ambisonic/3";
pub const CLAP_EXT_AMBISONIC_COMPAT: &::std::ffi::CStr = c"clap.ambisonic.draft/3";
pub const CLAP_PORT_AMBISONIC: &::std::ffi::CStr = c"ambisonic";
...
pub type clap_ambisonic_ordering = std::ffi::c_uint;
...
pub type clap_ambisonic_normalization = std::ffi::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_EXT_AUDIO_PORTS_ACTIVATION: &::std::ffi::CStr = c"clap.audio-ports-activation/2";
pub const CLAP_EXT_AUDIO_PORTS_ACTIVATION_COMPAT: &::std::ffi::CStr =
    c"clap.audio-ports-activation/draft-2";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_EXT_AUDIO_PORTS: &::std::ffi::CStr = c"clap.audio-ports";
pub const CLAP_PORT_MONO: &::std::ffi::CStr = c"mono";
pub const CLAP_PORT_STEREO: &::std::ffi::CStr = c"stereo";
...
pub struct clap_audio_port_info {
    pub id: clap_id,
    pub name: [std::ffi::c_char; 256usize],
    pub flags: u32,
    pub channel_count: u32,
    pub port_type: *const std::ffi::c_char,
...
pub const CLAP_EXT_AUDIO_PORTS_CONFIG: &::std::ffi::CStr = c"clap.audio-ports-config";
pub const CLAP_EXT_AUDIO_PORTS_CONFIG_INFO: &::std::ffi::CStr = c"clap.audio-ports-config-info/1";
pub const CLAP_EXT_AUDIO_PORTS_CONFIG_INFO_COMPAT: &::std::ffi::CStr =
    c"clap.audio-ports-config-info/draft-0";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct clap_audio_ports_config {
    ...
    pub main_input_port_type: *const std::ffi::c_char,
    pub has_main_output: bool,
    pub main_output_channel_count: u32,
    pub main_output_port_type: *const std::ffi::c_char,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
pub const CLAP_EXT_CONFIGURABLE_AUDIO_PORTS: &::std::ffi::CStr = c"clap.configurable-audio-ports/1";
pub const CLAP_EXT_CONFIGURABLE_AUDIO_PORTS_COMPAT: &::std::ffi::CStr =
    c"clap.configurable-audio-ports.draft1";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct clap_audio_port_configuration_request {
    ...
    pub channel_count: u32,
    pub port_type: *const std::ffi::c_char,
    pub port_details: *const std::ffi::c_void,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
pub const CLAP_EXT_CONTEXT_MENU: &::std::ffi::CStr = c"clap.context-menu/1";
pub const CLAP_EXT_CONTEXT_MENU_COMPAT: &::std::ffi::CStr = c"clap.context-menu.draft/0";
...
pub struct clap_context_menu_builder {
    ...
    pub add_item: ::std::option::Option<
        unsafe extern "C" fn(
            ...
            item_data: *const std::ffi::c_void,
        ) -> bool,
    >,
...
pub const CLAP_EXT_EVENT_REGISTRY: &::std::ffi::CStr = c"clap.event-registry";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct clap_host_event_registry {
    pub query: ::std::option::Option<
        unsafe extern "C" fn(
            host: *const clap_host_t,
            space_name: *const std::ffi::c_char,
            space_id: *mut u16,
        ) -> bool,
    >,
}
...
pub const CLAP_EXT_GUI: &::std::ffi::CStr = c"clap.gui";
pub const CLAP_WINDOW_API_WIN32: &::std::ffi::CStr = c"win32";
pub const CLAP_WINDOW_API_COCOA: &::std::ffi::CStr = c"cocoa";
pub const CLAP_WINDOW_API_X11: &::std::ffi::CStr = c"x11";
pub const CLAP_WINDOW_API_WAYLAND: &::std::ffi::CStr = c"wayland";
pub type clap_hwnd = *mut std::ffi::c_void;
pub type clap_nsview = *mut std::ffi::c_void;
pub type clap_xwnd = std::ffi::c_ulong;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clap_window {
    pub api: *const std::ffi::c_char,
...
pub struct clap_plugin_gui {
    ...
    pub suggest_title: ::std::option::Option<
        unsafe extern "C" fn(plugin: *const clap_plugin_t, title: *const std::ffi::c_char),
    >,
...
pub const CLAP_EXT_LATENCY: &::std::ffi::CStr = c"clap.latency";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_EXT_LOG: &::std::ffi::CStr = c"clap.log";
...
pub const CLAP_EXT_NOTE_NAME: &::std::ffi::CStr = c"clap.note-name";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_EXT_NOTE_PORTS: &::std::ffi::CStr = c"clap.note-ports";
...
pub type clap_note_dialect = std::ffi::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_EXT_PARAMS: &::std::ffi::CStr = c"clap.params";
...
pub struct clap_param_info {
    ...
    pub cookie: *mut std::ffi::c_void,
    pub name: [std::ffi::c_char; 256usize],
    pub module: [std::ffi::c_char; 1024usize],
    pub min_value: f64,
    pub max_value: f64,
...
pub struct clap_plugin_params {
    ...
    pub text_to_value: ::std::option::Option<
        unsafe extern "C" fn(
            plugin: *const clap_plugin_t,
            param_id: clap_id,
            param_value_text: *const std::ffi::c_char,
            out_value: *mut f64,
        ) -> bool,
    >,
...
pub const CLAP_EXT_PARAM_INDICATION: &::std::ffi::CStr = c"clap.param-indication/4";
pub const CLAP_EXT_PARAM_INDICATION_COMPAT: &::std::ffi::CStr = c"clap.param-indication.draft/4";
...
pub const CLAP_EXT_POSIX_FD_SUPPORT: &::std::ffi::CStr = c"clap.posix-fd-support";
...
pub struct clap_host_posix_fd_support {
    ...
    pub unregister_fd: ::std::option::Option<
        unsafe extern "C" fn(host: *const clap_host_t, fd: std::ffi::c_int) -> bool,
    >,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
pub const CLAP_EXT_PRESET_LOAD: &::std::ffi::CStr = c"clap.preset-load/2";
pub const CLAP_EXT_PRESET_LOAD_COMPAT: &::std::ffi::CStr = c"clap.preset-load.draft/2";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_EXT_REMOTE_CONTROLS: &::std::ffi::CStr = c"clap.remote-controls/2";
pub const CLAP_EXT_REMOTE_CONTROLS_COMPAT: &::std::ffi::CStr = c"clap.remote-controls.draft/2";
...
pub struct clap_remote_controls_page {
    pub section_name: [std::ffi::c_char; 256usize],
    pub page_id: clap_id,
    pub page_name: [std::ffi::c_char; 256usize],
...
pub const CLAP_EXT_RENDER: &::std::ffi::CStr = c"clap.render";
...
pub const CLAP_EXT_STATE_CONTEXT: &::std::ffi::CStr = c"clap.state-context/2";
...
pub type clap_plugin_state_context_type = std::ffi::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_EXT_STATE: &::std::ffi::CStr = c"clap.state";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_EXT_SURROUND: &::std::ffi::CStr = c"clap.surround/4";
pub const CLAP_EXT_SURROUND_COMPAT: &::std::ffi::CStr = c"clap.surround.draft/4";
pub const CLAP_PORT_SURROUND: &::std::ffi::CStr = c"surround";
...
pub const CLAP_EXT_TAIL: &::std::ffi::CStr = c"clap.tail";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_EXT_THREAD_CHECK: &::std::ffi::CStr = c"clap.thread-check";
...
pub const CLAP_EXT_THREAD_POOL: &::std::ffi::CStr = c"clap.thread-pool";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_EXT_TIMER_SUPPORT: &::std::ffi::CStr = c"clap.timer-support";
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const CLAP_EXT_TRACK_INFO: &::std::ffi::CStr = c"clap.track-info/1";
pub const CLAP_EXT_TRACK_INFO_COMPAT: &::std::ffi::CStr = c"clap.track-info.draft/1";
...
pub struct clap_track_info {
    ...
    pub audio_port_type: *const std::ffi::c_char,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
pub const CLAP_EXT_VOICE_INFO: &::std::ffi::CStr = c"clap.voice-info";
pub const CLAP_VOICE_INFO_SUPPORTS_OVERLAPPING_NOTES: _bindgen_ty_20 = 1;
pub type _bindgen_ty_20 = std::ffi::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
